package com.dicoding.submissionawalintermediate.utils
...
import com.dicoding.submissionawalintermediate.data.remote.response.LoginResult
import com.dicoding.submissionawalintermediate.data.remote.response.RegisterResponse
import com.dicoding.submissionawalintermediate.data.remote.response.Stories
...
object Dummy {
    fun generateDummyStoriesResponse(): StoriesResponse {
        ...
        val listStory = mutableListOf<Stories>()
